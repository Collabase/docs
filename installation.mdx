---
title: "Installation"
description: "Install Collabase on your own server using Docker Compose and the one-command installer. Covers system requirements, ports, and environment configuration."
---

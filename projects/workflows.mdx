...
description: "Define custom task statuses, allowed transitions, and task types in Collabase Projects to model your team's workflow — from kanban to complex pipelines."
---

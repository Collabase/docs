...
<Note>
  Replace `collabase-postgres` with your actual container name if you customized the Docker Compose configuration. Replace `-U collabase collabase` if you changed the PostgreSQL username or database name.
</Note>

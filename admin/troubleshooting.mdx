...
### SSO not working (Google, GitHub, SAML)
...
<Steps>
  <Step title="Verify the redirect URI matches exactly">
    The redirect URI registered in your OAuth provider (Google Cloud Console, GitHub, etc.) must match the URL Collabase is actually running on — including `https://` and no trailing slash.
  </Step>
  <Step title="Check the Client ID and Client Secret">
    In **Admin → Identity Providers**, re-enter the credentials and click **Test Connection** if available.
  </Step>

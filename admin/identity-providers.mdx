...
<CardGroup cols={5}>
  <Card>
    <img src="/images/keycloak.png" alt="Keycloak" style={{ height: '36px', objectFit: 'contain' }} />
  </Card>
  <Card>
    <img src="/images/okta.webp" alt="Okta" style={{ height: '36px', objectFit: 'contain' }} />
  </Card>
</CardGroup>
...
| **GitHub** | GitHub OAuth App. Requires creating an OAuth App in your GitHub organization. |
...
When SSO is the primary authentication method for your organization, you may still need certain admin accounts to be able to log in with a password — for example, a break-glass admin account.

...
description: "Configure single sign-on by connecting Collabase to your identity provider with OAuth 2.0, LDAP, or SAML 2.0. Supports Okta, Entra ID, and more."
---

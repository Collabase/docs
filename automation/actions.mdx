...
<CardGroup cols={3}>
  <Card title="Communication" icon="message" href="/automation/connectors/overview">Slack, Teams, Discord, Email, Telegram…</Card>
  <Card title="Developer Tools" icon="code" href="/automation/connectors/overview">GitHub, GitLab, Jira, Sentry…</Card>
  <Card title="AI & Utilities" icon="wand-magic-sparkles" href="/automation/connectors/overview">OpenAI, HTTP, Transform, Code…</Card>
</CardGroup>

→ [View all 40+ connectors](/automation/connectors/overview)

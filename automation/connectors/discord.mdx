...
description: "Set up the Discord connector in Collabase Automation: Bot token authentication, 3 triggers such as Message Created and 9 actions such as Send Message."
---

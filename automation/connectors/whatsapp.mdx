...
description: "Set up the WhatsApp connector in Collabase Automation: API Key authentication, 3 triggers such as Message Received and 5 actions such as Send Text Message."
---

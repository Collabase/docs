---
title: "WhatsApp"
description: "Connect Collabase Automation to WhatsApp Business API to send messages, media, templates, and locations. Trigger workflows when inbound messages arrive."
---

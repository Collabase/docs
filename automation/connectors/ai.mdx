---
title: "AI (local) connector"
sidebarTitle: "AI (local)"
description: "Set up the AI (local) connector in Collabase Automation: API Key authentication and 2 actions such as Generate Text."
---

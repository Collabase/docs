...
description: "Set up the Telegram connector in Collabase Automation: API Key authentication, 3 triggers such as Message Received and 9 actions such as Send Message."
---

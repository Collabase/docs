---
title: "Telegram"
description: "Connect Collabase Automation to Telegram to send messages, media, and keyboard buttons, edit or pin messages, and react to incoming chats via the Bot API."
---

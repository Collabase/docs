...
sidebarTitle: "Trello"
description: "Set up the Trello connector in Collabase Automation: API Key + Token authentication, 4 triggers such as Card Created and 8 actions such as Create Card."
---

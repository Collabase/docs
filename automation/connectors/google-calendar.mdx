...
description: "Set up the Google Calendar connector in Collabase Automation: OAuth 2.0 authentication, 4 triggers such as Event Created and 11 actions such as Create Event."
---

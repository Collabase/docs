...
description: "Automate Google Calendar from Collabase — create, update, and delete events, check free/busy availability, respond to invitations, and sync calendar data."
---

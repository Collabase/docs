...
description: "Set up the Dropbox connector in Collabase Automation: OAuth 2.0 authentication, 2 triggers such as File Uploaded and 6 actions such as List Folder."
---

...
description: "Set up the Google Sheets connector in Collabase Automation: OAuth 2.0 authentication, 2 triggers such as New Row Added and 9 actions such as Get Row(s)."
---

---
title: "GitLab"
description: "Connect Collabase Automation to GitLab to manage issues, merge requests, trigger CI/CD pipelines, and start workflows in response to GitLab webhook events."
---

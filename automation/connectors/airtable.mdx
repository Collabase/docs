...
description: "Set up the Airtable connector in Collabase Automation: API Key authentication, 3 triggers such as Record Created and 7 actions such as List Records."
---

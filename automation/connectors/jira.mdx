...
sidebarTitle: "Jira"
description: "Set up the Jira connector in Collabase Automation: Basic authentication, 5 triggers such as Issue Created and 7 actions such as Create Issue."
---

...
sidebarTitle: "Notion"
description: "Set up the Notion connector in Collabase Automation: API Key authentication, 2 triggers such as Page Created and 6 actions such as Create Page."
---

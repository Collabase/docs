...
sidebarTitle: "Asana"
description: "Set up the Asana connector in Collabase Automation: OAuth 2.0 authentication, 4 triggers such as Task Created and 6 actions such as Create Task."
---

...
description: "Set up the Outlook Calendar connector in Collabase Automation: OAuth 2.0 authentication, 4 triggers such as Event Created and 7 actions such as Create Event."
---

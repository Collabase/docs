...
sidebarTitle: "Sentry"
description: "Set up the Sentry connector in Collabase Automation: API Key authentication, 4 triggers such as New Issue Created and 7 actions such as List Issues."
---

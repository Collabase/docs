...
sidebarTitle: "Linear"
description: "Set up the Linear connector in Collabase Automation: API Key authentication, 4 triggers such as Issue Created and 6 actions such as Create Issue."
---

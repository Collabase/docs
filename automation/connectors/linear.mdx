---
title: "Linear"
description: "Connect Collabase Automation to Linear to manage issues, projects, and teams through the GraphQL API. React to Linear events and sync data bidirectionally."
---

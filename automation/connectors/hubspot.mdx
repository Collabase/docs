...
description: "Set up the HubSpot connector in Collabase Automation: API Key authentication, 8 triggers such as Contact Created and 11 actions such as Create Contact."
---

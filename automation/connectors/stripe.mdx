...
sidebarTitle: "Stripe"
description: "Set up the Stripe connector in Collabase Automation: API Key authentication, 7 triggers such as Payment Succeeded and 14 actions such as Create Customer."
---

...
sidebarTitle: "Code"
description: "Run your own JavaScript inside a Collabase automation with the Code connector: transform data, compute values and pass results to the next node."
---

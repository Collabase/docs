...
description: "Set up the SendGrid connector in Collabase Automation: API Key authentication, 6 triggers such as Email Delivered and 7 actions such as Send Email."
---

...
description: "Connect Collabase Automation to Microsoft Teams to send channel messages, create online meetings, and manage team membership via the Microsoft Graph API."
---

...
description: "Set up the Pipedrive connector in Collabase Automation: API Key authentication, 6 triggers such as Deal Created and 9 actions such as Create Deal."
---

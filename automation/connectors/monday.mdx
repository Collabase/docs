...
description: "Set up the Monday.com connector in Collabase Automation: API Key authentication, 3 triggers such as Item Created and 7 actions such as Create Item."
---

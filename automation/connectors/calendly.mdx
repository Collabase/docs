...
description: "Set up the Calendly connector in Collabase Automation: API Key authentication, 2 triggers such as Event Scheduled and 5 actions such as List Events."
---

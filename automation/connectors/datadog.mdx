---
title: "Datadog"
description: "Connect Collabase Automation to Datadog to send custom events, query metrics, manage monitors, and automatically create or update incidents from workflows."
---

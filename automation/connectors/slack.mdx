...
sidebarTitle: "Slack"
description: "Set up the Slack connector in Collabase Automation: Bot token authentication, 4 triggers such as Message Posted and 10 actions such as Send Message."
---

...
description: "Set up the PagerDuty connector in Collabase Automation: API Key authentication, 4 triggers such as Incident Triggered and 6 actions such as Create Incident."
---

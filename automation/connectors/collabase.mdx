---
title: "Collabase (built-in) connector"
sidebarTitle: "Collabase (built-in)"
description: "Set up the Collabase (built-in) connector in Collabase Automation: 11 triggers such as Task Created and 21 actions such as Search Tasks."
---

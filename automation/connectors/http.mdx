---
title: "HTTP"
description: "Use the HTTP connector to make GET, POST, PUT, PATCH, and DELETE requests to any external API or webhook endpoint from your Collabase automation steps."
---

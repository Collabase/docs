...
sidebarTitle: "HTTP"
description: "Call any REST API from Collabase Automation with the HTTP connector: one HTTP Request action for GET, POST, PUT, PATCH and DELETE with headers and body."
---

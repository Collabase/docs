---
title: "Transform"
description: "Use Transform nodes to format dates, filter arrays, reshape JSON objects, and map values between steps in your Collabase automation without writing code."
---

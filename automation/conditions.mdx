---
title: "Conditions"
description: "Condition nodes filter whether an automation continues — if a condition fails, the pipeline stops at that branch."
---
...
<Note>
  A stopped execution is not the same as a failed execution. Stopping at a condition is the expected, healthy behavior — the automation worked correctly, and the event simply did not meet your criteria.
</Note>

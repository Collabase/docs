...
| Field | Description |
|---|---|
| **Full name** | The name shown next to your content, comments, and in member lists |
| **Role / job title** | Your position in the company, stored with your account |
| **Phone number** | An optional contact number. Only you and your administrators can see it. |
| **Date of birth** | Optional. If your company uses the Intranet, it appears in the birthday list there. |
| **Email** | Your login address — used for password resets and email notifications |
| **Avatar** | A profile picture shown throughout Collabase. Click your current picture to upload a new one. |

Click **Save changes** after editing any field.

### Phone number format

Enter your number the way you would dial it from abroad: a plus sign, your country code, then the number. Spaces and dashes are fine — Collabase tidies them up when it saves.

| You type | Collabase saves |
|---|---|
| `+41 44 123 45 67` | `+41441234567` |
| `+1 (555) 000-0000` | `+15550000000` |

A number without a country code, such as `044 123 45 67`, is not accepted: **Save changes** stays greyed out and the field explains what is missing. Add your country code to the front and it will save. Leaving the field empty is fine — the number is optional.

<Note>
  If you had a number saved before this rule existed, it may now show as incomplete. Add your country code the next time you edit your profile.
</Note>

### Language

Collabase is fully translated into four languages. Choose yours on the **Preferences** tab:

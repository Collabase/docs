...
description: "Use the Registry to define custom schemas, populate them with objects, and connect data with typed relations — no code or external database required."
---

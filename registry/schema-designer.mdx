...
description: "Use the visual Schema Designer canvas to build your Registry data model — create Object Types, define Attributes, and draw typed Relations in an ER diagram."
---

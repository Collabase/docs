...
To show the files inside the page content, insert the **Attachments** macro. To find and organize the
attachments of all your pages and work items, use the Documents app. See
[Documents and attachments](/concepts/documents).

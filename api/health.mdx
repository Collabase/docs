---
title: "Health check"
description: "Check whether the Collabase REST API is reachable and responsive. Returns the current server version, uptime, and database connection status in the response."
api: "GET /api/health"
---

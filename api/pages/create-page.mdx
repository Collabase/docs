---
title: "Create page"
description: "Create a new document or blog page inside a Collabase space via the REST API. Specify the title, content body, parent page, and publication status."

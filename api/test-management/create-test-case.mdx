...
description: "Add a new test case to a test management project via the REST API. Specify the title, description, preconditions, steps, expected results, and suite assignment."

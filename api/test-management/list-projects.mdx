---
title: "List projects"
description: "Return all test management projects in a Collabase space that your API key can access, including project name, case count, and latest run summary."

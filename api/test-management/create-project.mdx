...
description: "Create a new test management project inside a Collabase space via the REST API. Define the project name and configure default settings for test cases."

...
description: "Return every automation workflow accessible to the authenticated API key, including each automation's name, status, trigger type, and last execution time."

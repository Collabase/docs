...
description: "Browse the catalog of public automation templates you can clone into your space. Each template includes a pre-built trigger, conditions, and action nodes."

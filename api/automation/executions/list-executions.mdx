...
description: "Retrieve the 50 most recent execution records for an automation, including run status, start and end timestamps, trigger data, and per-node results."

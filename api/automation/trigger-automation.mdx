...
description: "Manually trigger an automation by its ID, bypassing the normal trigger condition. Pass optional input data as the request body to feed into the workflow."

...
description: "Create a new automation workflow by defining its name, trigger type, condition nodes, and action steps. Returns the full automation object on success."

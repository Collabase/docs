...
You write blog posts the same way you write standard pages. The routing to the feed is handled by the platform.

## Creating a blog post

<Steps>
  <Step title="Open your Space">
    Navigate to the Space where you want to publish the post. Use a Space with `INTERNAL` visibility if the post is meant for the whole organisation, or a `PRIVATE` Space if it is for your department or team only.
  </Step>
